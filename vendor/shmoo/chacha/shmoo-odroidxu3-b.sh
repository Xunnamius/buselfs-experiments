...
RESULTS_FILE="/home/odroid/bd3/rsync/energy-AES-1/results/shmoo.big.results"
...
do
  ...
  do
    ...
    do
      ...
      command="taskset $mask python3 /home/odroid/bd3/rsync/energy-AES-1/python-chacha.py big"
      echo $command
      $command
      c="$?"
      echo "returned $c"
