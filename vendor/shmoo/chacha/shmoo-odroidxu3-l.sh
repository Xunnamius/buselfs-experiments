...
RESULTS_FILE="/home/odroid/bd3/rsync/energy-AES-1/results/shmoo.little.results"
...
#   mask=$((mask << CORES_START))
  ...
  do
    ...
    do
      ...
      command="taskset $mask python3 /home/odroid/bd3/rsync/energy-AES-1/python-chacha.py little"
      echo $command
      $command
      c="$?"
      echo "returned $c"
