...
RESULTS_FILE="/home/odroid/bd3/rsync/energy-AES-1/results/shmoo.little.nfde.results"
...
do
  ...
  do
    ...
    do
      ...
      command="taskset $mask python3 /home/odroid/bd3/rsync/energy-AES-1/python-freerun.py little nfde /media/nfde-RAMDSK/tmp.txt"
      echo $command
      $command
      c="$?"
      echo "returned $c"
