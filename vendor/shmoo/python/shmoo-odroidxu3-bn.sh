...
RESULTS_FILE="/home/odroid/bd3/repos/energy-AES-1/results/shmoo.big.nfde.results"
...
do
  ...
  do
    ...
    do
      ...
      command="taskset $mask python3 /home/odroid/bd3/repos/energy-AES-1/python-freerun.py big nfde /media/nfde-RAMDSK"
      echo $command
      $command
      c="$?"
      echo "returned $c"
