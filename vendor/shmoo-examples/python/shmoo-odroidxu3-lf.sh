...
RESULTS_FILE="/home/odroid/bd3/rsync/energy-AES-1/results/shmoo.little.fde.results"
...
do
  ...
  do
    ...
    do
      ...
      command="taskset $mask python3 /home/odroid/bd3/rsync/energy-AES-1/python-freerun.py little fde /media/fde-RAMDSK/tmp.txt"
      echo $command
      $command
      c="$?"
      echo "returned $c"
