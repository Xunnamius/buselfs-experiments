...
int main(int argc, char * argv[])
{
    ...
    check_args_and_perms_noratio(argc, "random-freerun-uc-batterysaver");
    ...
    snprintf(path_shard, PATH_BUFF_SIZE, "results/random_freerun_uc_batterysaver.%s.%s.results", core_type, fs_type);
