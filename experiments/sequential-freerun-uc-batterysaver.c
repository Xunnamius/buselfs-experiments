...
int main(int argc, char * argv[])
{
    ...
    while(keepRunning && trials--)
    {
        ...
        u_int64_t write1len = calc_len(fsize, SWAP_RATIO_50S_50P, RETURN_PRIMARY_LENGTH);
        ...
        u_int64_t read1len = calc_len(fsize, SWAP_RATIO_50S_50P, RETURN_PRIMARY_LENGTH);
        ...
        u_int64_t write2len = calc_len(fsize, SWAP_RATIO_50S_50P, RETURN_SWAP_LENGTH);
        char * randomnessCopy2 = randomness;

        // ? Start writing at the end of the initial write
        lseek64(trialoutfd, calc_len(fsize, SWAP_RATIO_50S_50P, RETURN_PRIMARY_LENGTH), SEEK_SET);
        ...
        u_int64_t read2len = calc_len(fsize, SWAP_RATIO_50S_50P, RETURN_SWAP_LENGTH);
