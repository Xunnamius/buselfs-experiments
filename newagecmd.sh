...
sudo modprobe f2fs
sudo mkdir ~/bd3/result mkdir /tmp/nbd0 /tmp/nbd1 /tmp/nbd2 /tmp/nbd3 /tmp/nbd4 /tmp/nbd5 /tmp/nbd6 /tmp/nbd7 /tmp/nbd8 /tmp/nbd9 /tmp/nbd10 /tmp/nbd11 /tmp/nbd12 /tmp/nbd13 /tmp/nbd14 /tmp/nbd15
cd /home/odroid/bd3/repos/energy-AES-1
cd ~/bd3/result
cd -
sudo modprobe brd rd_nr=1 rd_size=1048576
sudo mkfs.ext4 /dev/ram0
sudo mount -t ext4 /dev/ram0 ~/bd3/result
...
sudo rm ~/bd3/result/logfs-nbd*.bkstr
