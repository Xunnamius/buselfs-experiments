...
with open('/home/odroid/bd3/rsync/energy-AES-1/results/shmoo.little.nfde.results', 'a') as out:
    wattsup.clearMemory()
    wattsup.logInternal(1)
    
    # Begin logging with Wattsup (above), run filebench (here), close out the
    # Wattsup logger (below)
    print("filebench returned: ", subprocess.call(["filebench", "-f", "/home/odroid/bd3/rsync/energy-AES-1/fb-personalities/fileserver-noninteractive-nfde-rd.f"], stdout=out))
